...
namespace XiaLM.Tool450.source.common
{
    ...
    public class CrcVerifyHelper
    {
        ...
        public static ushort CRC16_CCITT_FALSE(byte[] buffer)
        {
            int crc = 0xFFFF;
        ...
        public static ushort CRC16_XMODEM(byte[] buffer)
        {
        ...
        public static ushort CRC16_MODBUS(byte[] buffer)
        {
            ushort crc = 0xFFFF;
            foreach (var b in buffer)
            {
        ...
        public static ushort CRC16_IBM(byte[] buffer)
        {
            ushort crc = 0x0000;
            foreach (var b in buffer)
            {
        ...
        public static ushort CRC16_MAXIM(byte[] buffer)
        {
            ushort crc = 0x0000;
            foreach (var b in buffer)
            {
        ...
        public static ushort CRC16_USB(byte[] buffer)
        {
            ushort crc = 0xFFFF;
            foreach (var b in buffer)
            {
