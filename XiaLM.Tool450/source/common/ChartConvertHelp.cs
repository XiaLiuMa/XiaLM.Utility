...
namespace XiaLM.Tool450.source.common
{
    ...
    public class ChartConvertHelp
    {
        ...
        /// <returns>(峰驼式)全拼拼音字符串</returns>
        public static string ConvertChineseToPinyin(string Chstr)
        {
        ...
        /// <returns></returns>
        public static string ConvertToUpper(string Chstr)
        {
            return Chstr.ToUpper();
        }
        ...
        /// <param name="Chstr"></param>
        /// <returns></returns>
        public static string ConvertToLower(string Chstr)
        {
            return Chstr.ToLower();
        }
    }
}
