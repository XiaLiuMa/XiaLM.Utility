...
namespace XiaLM.Tool450.source.common
{
    ...
    public class ValidatorHelper
    {
        ...
        {
            if (!ifValidateWhiteSpace && string.IsNullOrWhiteSpace(inputStr)) return false;
            Regex regex = null;
            if (ifIgnoreCase) regex = new Regex(patternStr, RegexOptions.IgnoreCase);//指定不区分大小写的匹配  
            else regex = new Regex(patternStr);
        ...
        public static bool IsNumber(string input)
        {
            ...
            double d = 0;
            if (double.TryParse(input, out d)) return true;
            return false;
        }
        ...
        public static bool IsIntegerNotNagtive(string input)
        {
            //return IsMatch(input, @"^\d+$");
            int i = -1;
            if (int.TryParse(input, out i) && i >= 0) return true;
            return false;
        }
        ...
        public static bool IsIntegerPositive(string input)
        {
            ...
            int i = 0;
            if (int.TryParse(input, out i) && i >= 1) return true;
            return false;
        }
        ...
        {
            if (!withEnglishCharacter && !withNumber && !withChineseCharacter) return false;
            StringBuilder patternString = new StringBuilder();
            patternString.Append("^[");
            if (withEnglishCharacter) patternString.Append("a-zA-Z");
            if (withNumber) patternString.Append("0-9");
            if (withChineseCharacter) patternString.Append(@"\u4E00-\u9FA5");
            patternString.Append("]+$");
        ...
        public static bool IsStringLength(string input, int lengthBegin, int lengthEnd)
        {
            ...
            if (input.Length >= lengthBegin && input.Length <= lengthEnd) return true;
            return false;
        }
        ...
        public static bool IsLongitude(string input)
        {
            ...
            float lon;
            if (float.TryParse(input, out lon) && lon >= -180 && lon <= 180) return true;
            return false;
        }
        ...
        public static bool IsLatitude(string input)
        {
            ...
            float lat;
            if (float.TryParse(input, out lat) && lat >= -90 && lat <= 90) return true;
            return false;
        }
    }
}
